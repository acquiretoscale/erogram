...
import { getHeroFilterSilos, type BrowseFilterItem } from '@/app/ofsearch/onlyfansBrowseFilterData';
  ...
  return (
    <div className={`rounded-xl border border-white/[0.08] bg-[#0a121c]/95 backdrop-blur-md shadow-[0_12px_40px_-16px_rgba(0,0,0,0.85)] ${
      ...
      <div className={`flex items-center justify-between border-t border-white/[0.07] ${compact ? 'pt-1.5' : 'pt-2'}`}>
        ...
        <Link href={lp('/ofsearch/categories')} className={`font-semibold text-[#00AFF0] hover:opacity-85 transition-opacity ${compact ? 'text-[9px]' : 'text-[11px]'}`}>
