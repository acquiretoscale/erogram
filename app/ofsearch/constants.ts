import { OF_KEYWORD_CATEGORIES } from '@/lib/ofsearch/keywordCategories';
...
/** Live /ofsearch hub BOA rows — prod order (28 slugs, 26 with BOA pages). */
...
/** Build the public SEO URL for a category page: /ofsearch/blonde */
