            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-4 bg-[#1a1a1a] border border-white/10 rounded-xl text-white placeholder:text-gray-600 focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition-all"
              ...
              <button
                ...
                className="w-full py-4 bg-amber-600 hover:bg-amber-500 text-white rounded-xl font-bold text-lg transition-all shadow-lg shadow-amber-600/20 disabled:opacity-50 disabled:cursor-not-allowed"
              >
