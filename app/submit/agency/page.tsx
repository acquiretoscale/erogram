...
export default function SubmitAgencyLandingPage() {
  return (
        ...
        <section className="relative overflow-hidden pb-12 sm:pb-16">
          ...
          <div className="relative max-w-2xl mx-auto px-4 sm:px-6">
            ...
            <div className="text-center mb-8 sm:mb-10">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#00AFF0] mb-2">For agencies</p>
            ...
            <SubmitCreatorForm posterType="agency" />
          </div>
        </section>
      </main>
