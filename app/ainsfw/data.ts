...
export const AI_NSFW_TOOLS: AINsfwTool[] = [
  ...
  {
    slug: slugify('Undress AI', 'Undressing AI'),
    name: 'Undressing AI',
    category: 'Undress AI',
    vendor: 'Undressing.ai',
    description: 'Undressing AI is built on the DeepNude Generator and does exactly what the name promises: it undresses any uploaded photo quickly and accurately. The service runs in the browser with a simple interface and a clearer privacy-facing presentation than most of its rivals, which counts for something in this niche. Users pick between models and quality levels, then let the AI do the rest. The results arrive instantly and effortlessly, no editing knowledge required. Undressing AI is the tidy, no-drama option for people who want the classic undress experience without studying a manual first.',
    image: 'https://pub-5800916b33a845e4b67e2d5be553c1e3.r2.dev/ainsfw/undressing-ai-undress-ai.webp',
    tags: ['ai undress'],
    subscription: 'Freemium & Paid',
    payment: ['Credit Cards', 'Crypto'],
    tryNowUrl: 'https://undressing.ai',
    sourceUrl: 'https://undressing.ai',
  },
  {
