...
const AD_SLOTS: AdSlot[] = [
  // Listing page slots (3 tiers: Platinum → Top Groups pos 2, Gold → Discover NSFW Telegram pos 3, Silver → Discover NSFW Groups pos 8)
  { id: 'feed-1', gridIdx: 0,  slotNo: 1, tier: 'platinum', page: 'listing', label: 'In-Feed Slot 1 (Platinum) — Top Groups', description: 'Premium first-touch position inside the Top Groups section (position 2). Captures the highest-intent attention immediately alongside the most popular groups.', videoPrice: '—', imagePrice: '—', estViews: 'Top share', estClicks: 'Highest volume', estCtr: 'High single-digit', valuePoints: ['Receives 40%+ of in-feed traffic share', 'Appears in the Top Groups section — first thing users see', 'Best choice for launches and aggressive scale'] },
  { id: 'feed-2', gridIdx: 4,  slotNo: 2, tier: 'gold', page: 'listing', label: 'In-Feed Slot 2 (Gold) — Discover NSFW Telegram', description: 'Position 3 in the Discover NSFW Telegram Groups section. Strong continuity from the Top Groups area, ideal for sustained volume.', videoPrice: '—', imagePrice: '—', estViews: 'Strong share', estClicks: 'Very high', estCtr: '~7-8% projected', valuePoints: ['Around 30% of in-feed traffic share', 'Appears early in the main feed as users start browsing', 'Great balance of reach and efficiency'] },
  { id: 'feed-3', gridIdx: 8,  slotNo: 3, tier: 'silver', page: 'listing', label: 'In-Feed Slot 3 (Silver) — Discover NSFW Groups', description: 'Position 8 in the Discover NSFW Groups feed. Captures deep-scroll users who are actively engaged and more likely to continue interacting.', videoPrice: '—', imagePrice: '—', estViews: 'Shared', estClicks: 'Consistent', estCtr: '~7% projected', valuePoints: ['Captures engaged deep-scroll audience', 'Strong value for ongoing visibility campaigns', 'High-quality engaged scroller audience'] },
